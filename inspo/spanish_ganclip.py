...
# i got the  credits from ai_images twitter intro and more of the people in the same that this is by.
...
# pylint: disable=no-member, redefined-builtin, redefined-outer-name

# @title set up definiitons
...
text_prompt = "a friendly intelligence that dreams images really opens new avenues of divination" #@param {type:"string"}
...
imagen_inicial =  None    #"decent_dryad_100.png"#@param {type:"string"}
imagenes_objetivo = None#@param {type:"string"}
seed = -1#@param {type:"number"}
max_iteraciones = 200 #@param {type:"number"}
input_images = ""

model_numbers={"vqgan_imagenet_f16_16384": 'ImageNet 16384',"vqgan_imagenet_f16_1024":"ImageNet 1024",
...
if args.text_prompt:
    print('Using texts:', args.prompts)
...
def make_video_if_done_globally():
